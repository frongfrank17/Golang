...
type AccountController interface {
	...
	ClosePrint(c *fiber.Ctx) error
}

type accountController struct {
	accountService services.BankService
}

func NewAccountController(accountService services.BankService) AccountController {
...
func (obj accountController) ClosePrint(c *fiber.Ctx) error {

	return c.JSON(fiber.Map{
		"message": "close print account success",
	})
}
